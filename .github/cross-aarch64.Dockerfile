...
# ubuntu-like
# 0.2.4 uses old glibc so use main, we need at least 2.29 (main has 2.31)
...
RUN export DEBIAN_FRONTEND=noninteractive \
    ...
    libgdk-pixbuf2.0-dev:arm64 libnss3:arm64 libasound2:arm64 libxss1:arm64 libnspr4:arm64 \
